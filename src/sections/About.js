...
function About() {
    return (
        <div id="about">
            <section className="h-auto flex items-center justify-center flex-col gap-6 px-6 text-justify py-12"  >
                ...
                <div className='flex items-center justify-center flex-col'>
                    <h3 className="text-2xl font-bold text-blue-600">Veja mais sobre mim!</h3>
                    ...
                    <div className="flex items-center justify-center ">
                        ...
                        <a href="https://github.com/luiz-divino" target="_blank" rel="noopener noreferrer" className="inline-block mt-6">
                            <img src={Github} alt="GitHub" className="w-12 h-12  rounded hover:opacity-75 transition-opacity" />
                        </a>
                    </div>
                </div>
